...
- `[V-] observation/segment_object` — Ground a named object into a 2D mask and noise-filtered 3D world points (SAM3 text prompt), the prerequisite for locating or grasping it.
